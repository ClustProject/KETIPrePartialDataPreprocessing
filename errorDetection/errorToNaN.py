class errorToNaN():
    ...
    def dataRangeInfoManager(self, data_type):
        from KETIPrePartialDataPreprocessing.errorDetection import dataRangeInfo_manager
    ...
    def getDataWithCertainNaN(self, data, CertainParam):
        if CertainParam['flag'] ==True:  
            from KETIPrePartialDataPreprocessing.errorDetection import certainError
    ...
    def getDataWithUncertainNaN(self, data, uncertainParam):    
        if uncertainParam['flag'] == True:
            from KETIPrePartialDataPreprocessing.errorDetection import unCertainError
